...
class FeedViewControlller: UIViewController {
    ...
    private let items: [FeedItemType] = [
        ...
        .post(FeedPostCellInfo(userImage: UIImage(named: "storyPhoto")!, username: "oop", postSubtitle: "Sponsored", postImage: UIImage(named: "photo")!, numberOfLikes: 515, comment: CommentShortInfo(username: "iosre", commentText: "fafaagkjhagskjhaskjhgjgsajsgajghjasgl"))),
        .post(FeedPostCellInfo(userImage: UIImage(named: "storyPhoto")!, username: "oop", postSubtitle: "Sponsored", postImage: UIImage(named: "photo")!, numberOfLikes: 515, comment: CommentShortInfo(username: "iosre", commentText: "fafaagkjhagskjhaskjhgjgsajsgajghjasgl"))),
        .post(FeedPostCellInfo(userImage: UIImage(named: "storyPhoto")!, username: "oop", postSubtitle: "Sponsored", postImage: UIImage(named: "photo")!, numberOfLikes: 515, comment: CommentShortInfo(username: "iosre", commentText: "fafaagkjhagskjhaskjhgjgsajsgajghjasgl"))),
        .post(FeedPostCellInfo(userImage: UIImage(named: "storyPhoto")!, username: "oop", postSubtitle: "Sponsored", postImage: UIImage(named: "photo")!, numberOfLikes: 515, comment: CommentShortInfo(username: "iosre", commentText: "fafaagkjhagskjhaskjhgjgsajsgajghjasgl")))
        ]
